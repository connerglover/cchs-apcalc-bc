...
\begin{document}
    ...
    \begin{center}
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle y = \sin x$\\[1ex]
            \smallgraph
        \end{minipage}
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle y = \cos x$\\[1ex]
            \smallgraph
        \end{minipage}
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle y = \tan x$\\[1ex]
            \smallgraph
        \end{minipage}
        ...
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle y = \csc x$\\[1ex]
            \smallgraph
        \end{minipage}
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle y = \sec x$\\[1ex]
            \smallgraph
        \end{minipage}
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle y = \cot x$\\[1ex]
            \smallgraph
        \end{minipage}
    \end{center}
    ...
    \begin{center}
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle y = \sin^{-1} x$\\[1ex]
            \smallgraph
        \end{minipage}
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle y = \cos^{-1} x$\\[1ex]
            \smallgraph
        \end{minipage}
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle y = \tan^{-1} x$\\[1ex]
            \smallgraph
        \end{minipage}
    \end{center}
