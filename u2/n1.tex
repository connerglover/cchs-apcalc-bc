...
\begin{document}
    ...
    \begin{center}
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle f(x)$\\[1ex]
            \smallgraph
        \end{minipage}
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle g(x)$\\[1ex]
            \smallgraph
        \end{minipage}
        \begin{minipage}{0.32\textwidth}
            \centering $\displaystyle f(x)$\\[1ex]
    ...
    \noindent Finally, something called the (seriously) Sandwich Theorem. Don't worry too much about this one (there will be more later).\\[3ex]
    \noindent Show that $\displaystyle \lim_{x\to0}\left[x^2\sin\!\left(\frac{1}{x}\right)\right]=0$.
